...
CREATE TYPE IF NOT EXISTS public.user_role AS ENUM ('child', 'parent', 'teacher');
...
CREATE TYPE IF NOT EXISTS course_type AS ENUM ('video', 'article', 'animation');
CREATE TYPE IF NOT EXISTS problem_type AS ENUM ('checkpoint', 'practice');
CREATE TYPE IF NOT EXISTS game_type AS ENUM ('ai', 'human');
CREATE TYPE IF NOT EXISTS game_status AS ENUM ('ongoing', 'finished', 'abandoned');
CREATE TYPE IF NOT EXISTS game_result AS ENUM ('black_win', 'white_win', 'draw');
CREATE TYPE IF NOT EXISTS achievement_type AS ENUM ('checkpoint', 'practice', 'game', 'course');
