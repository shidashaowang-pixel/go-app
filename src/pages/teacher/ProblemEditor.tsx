...
export default function ProblemEditor() {
  ...
  const [winCondition, setWinCondition] = useState<'exact_move' | 'capture' | 'make_eyes' | 'kill_opponent'>(
  ...
  const handleSave = async () => {
    ...
    // 检查是否有正解
    const hasSolution = solutionBranches.some(b => b.moves.length > 0);
    if (!hasSolution) {
      toast.error('请在棋盘上点击设置至少一个正解落子');
      return;
    }
                  ...
                  <div>
                    ...
                    <Select value={winCondition} onValueChange={(v) => setWinCondition(v as typeof winCondition)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="capture">�捕获棋子（吃到对方即胜利）</SelectItem>
